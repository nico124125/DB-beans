...
DELETE_PLANE_BY_NAME = "DELETE FROM planes WHERE name = ?;"import sqlite3


CREATE_PLANE_TABLE = "CREATE TABLE IF NOT EXISTS planes (id INTEGER PRIMARY KEY, name TEXT, meimport sqlite3
...
DELETE_PLANE_BY_ID = "DELETE FROM planes WHERE id = ?;"
...
def delete_plane_by_id(connection, plane_id):
    with connection:
        return connection.execute(DELETE_PLANE_BY_ID, (plane_id, ))thod TEXT, rating INTEGER);"
...
def delete_plane_by_id(connection, plane_id):
    with connection:
        return connection.execute(DELETE_PLANE_BY_ID, (plane_id, ))
GET_ALL_PLANES = "SELECT * FROM planes;"
GET_PLANES_BY_NAME = "SELECT * FROM planes WHERE name = ?;"
